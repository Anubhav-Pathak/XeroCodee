      ...
      <section className="bg-secondary rounded-curved flex flex-wrap justify-center gap-8 items-center p-8 relative overflow-hidden">
        <div className="text-center mb-24 lg:mb-0 lg:border-r lg:pr-8">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <button className="btn bg-transparent border-neutral hover:bg-transparent"> Sign Up with Google</button>
            <button className="btn bg-transparent border-neutral hover:bg-transparent"> Sign Up with GitHub</button>
          </div>
